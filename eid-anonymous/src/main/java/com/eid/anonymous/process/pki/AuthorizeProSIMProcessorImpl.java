 ...
 */
@Slf4j
@Component("pkiAuthorizeProSIMProcessorImpl")
@BizImpl(value = {BizType.AUTHORIZE_SIM_ASYNC})
public class AuthorizeProSIMProcessorImpl extends AuthenticationProcessor {
