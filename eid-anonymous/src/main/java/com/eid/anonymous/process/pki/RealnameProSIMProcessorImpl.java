 ...
 */
@Slf4j
@Component("pkiRealnameProSIMProcessorImpl")
@BizImpl(value = {BizType.IDENTITY_SIM_ASYNC})
public class RealnameProSIMProcessorImpl extends AuthenticationProcessor {
